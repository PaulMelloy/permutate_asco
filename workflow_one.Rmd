...
```{r}
f_scenarios <-lapply(1:20, FUN = function(x) sample_dates(dates = crutial_days))
```
...
perm_fg <- foreach(fcide = f_scenarios,
                   w = f_dat,
                   .packages = "ascotraceR", 
                   .inorder=FALSE) %dopar% {
                     trace_asco(
                       ...
                       primary_infection_foci = expand.grid(x = 1:20,
                                                            y = 1:10,
                                                            load = 5),
                       spores_per_gp_per_wet_hour = 0.7,
